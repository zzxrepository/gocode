...
> 原作者：[dunwu（钝悟）](https://github.com/dunwu) · [原文](https://dunwu.github.io/bigdata-tutorial/kafka/Kafka%E5%8F%AF%E9%9D%A0%E4%BC%A0%E8%BE%93.html) · [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)。本页按原许可转载，调整了导航、目录和资源链接，正文保留原版内容。
>
...
[Kafka 生产者](./02-producer.html) 中提到了，Kafka 有三种发送方式：同步、异步、异步回调。
