...
> 原作者：[dunwu（钝悟）](https://github.com/dunwu) · [原文](https://dunwu.github.io/bigdata-tutorial/kafka/Kafka%E9%9B%86%E7%BE%A4.html) · [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)。本页按原许可转载，调整了导航、目录和资源链接，正文保留原版内容。
>
> **版本说明：** 原文含 Kafka 2.x、Java 8 与 ZooKeeper 时代的示例；Kafka 4.x 已移除 ZooKeeper 模式。运行命令前请对照 [Kafka 4.3 官方快速入门](https://kafka.apache.org/43/getting-started/quickstart/)。
> 配图修复：原文一张图片的文件名缺少日期前缀，已从原作者图床补全并保存到本地。
...
>
> 详细内容可以参考：[ZooKeeper 原理](https://github.com/dunwu/bigdata-tutorial/blob/b3f38146d8ce7613aca819a628683a87ff513765/docs/zookeeper/ZooKeeper原理.md)
