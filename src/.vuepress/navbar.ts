...
export default navbar([
  ...
  { text: "算法与数据结构", icon: "diagram-project", link: "/tree/" },
    ...
    children: [
      {
        ...
        children: [
          ...
          { text: "GLM（智谱清言）", link: "https://chatglm.cn/" },
      ...
      },
      {
        ...
        children: [
          ...
          { text: "GLM Coding Plan（Agent / 编程）", link: "https://z.ai/subscribe" },
