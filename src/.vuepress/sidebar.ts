      ...
      children: [
        {
          ...
          collapsible: true,
          collapsed: false,
          children: [{ text: "基础语法与项目结构", link: "/backend/go/basics" }],
        },
        {
          text: "并发编程",
          ...
          collapsible: true,
          collapsed: false,
          children: [{ text: "Goroutine、Channel 与 Context", link: "/backend/go/concurrency" }],
        },
        {
          text: "Web 开发：Gin",
          icon: "globe",
          collapsible: true,
          collapsed: false,
          children: [{ text: "Gin 服务开发", link: "/backend/go/gin" }],
        },
        {
          text: "工程实践",
          icon: "gears",
          collapsible: true,
          collapsed: false,
          children: [{ text: "配置、日志、测试与部署", link: "/backend/go/engineering" }],
        },
      ],
    },
    {
      ...
      collapsed: false,
      children: [
        { text: "Java 基础", icon: "book-open", children: [{ text: "Java 基础语法与面向对象", link: "/backend/java/basics" }] },
        { text: "集合与并发", icon: "boxes-stacked", children: [{ text: "集合框架与并发编程", link: "/backend/java/collections-and-concurrency" }] },
        { text: "JVM 与框架", icon: "microchip", children: [{ text: "JVM 与 Spring 生态", link: "/backend/java/jvm-and-frameworks" }] },
      ],
    },
    {
      text: "数据库",
      ...
      collapsed: false,
      children: [
        { text: "MySQL", icon: "table", children: [{ text: "MySQL 基础、索引与事务", link: "/backend/database/mysql" }] },
        { text: "Redis", icon: "bolt", children: [{ text: "Redis 缓存与常用场景", link: "/backend/database/redis" }] },
      ],
    },
    {
      text: "微服务与分布式",
  ...
  "/frontend/": [
    {
      ...
      collapsible: true,
      collapsed: false,
      children: [{ text: "HTML 基础与语义化", link: "/frontend/html" }],
    },
    {
      text: "CSS",
      ...
      collapsible: true,
      collapsed: false,
      children: [{ text: "CSS 布局与样式", link: "/frontend/css" }],
    },
    {
      text: "JavaScript",
      icon: "fa6-brands:js",
      collapsible: true,
      collapsed: false,
      children: [{ text: "JavaScript 基础与浏览器编程", link: "/frontend/javascript" }],
    },
  ],
  "/algorithm/": [
    {
