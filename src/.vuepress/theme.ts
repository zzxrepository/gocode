  ...
  plugins: {
    ...
    redirect: {
      config: {
        ...
        "/backend/go/advanced/04-engineering-practice/01-viper-config/": "/backend/go/frameworks-and-ecosystem/04-common-libraries/01-configuration/01-viper-config/",
        "/backend/go/advanced/06-third-party-libraries/01-viper-config/": "/backend/go/frameworks-and-ecosystem/04-common-libraries/01-configuration/01-viper-config/",
        "/java/": "/backend/java/",
